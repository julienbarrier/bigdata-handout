...
Now, let's move to the data $C_{ij}$.
...
Before trying to make anycalculation, we can assume that Exxon and Chevron data
are strongly correlated, as well as JP Morgan and Bank of America.
